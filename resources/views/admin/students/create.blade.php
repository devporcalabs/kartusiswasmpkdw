                    ...
                    <form action="{{ route('admin.students.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="nis" id="nis" value="{{ old('nis') }}" class="w-full text-sm border-gray-300 rounded-md shadow-sm @error('nis') border-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <input type="text" name="nisn" id="nisn" value="{{ old('nisn') }}" class="w-full text-sm border-gray-300 rounded-md shadow-sm @error('nisn') border-red-500 @enderror">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="nama_lengkap" id="nama_lengkap" value="{{ old('nama_lengkap') }}" required class="w-full text-sm border-gray-300 rounded-md shadow-sm @error('nama_lengkap') border-red-500 @enderror">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="agama" id="agama" value="{{ old('agama') }}" class="w-full text-sm border-gray-300 rounded-md shadow-sm">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="tempat_tanggal_lahir" id="tempat_tanggal_lahir" value="{{ old('tempat_tanggal_lahir') }}" placeholder="Contoh: BEKASI, 26 JUNI 2013" class="w-full text-sm border-gray-300 rounded-md shadow-sm">
                            </div>

                            <!-- Kelas -->
                            <div>
                                <label for="kelas" class="block text-sm font-semibold text-gray-700 mb-1">Kelas</label>
                                <input type="text" name="kelas" id="kelas" value="{{ old('kelas') }}" placeholder="Contoh: KELAS 7.01" class="w-full text-sm border-gray-300 rounded-md shadow-sm">
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="nomor_ortu" id="nomor_ortu" value="{{ old('nomor_ortu') }}" placeholder="Contoh: 628951234567" class="w-full text-sm border-gray-300 rounded-md shadow-sm">
                        </div>

                        <!-- Alamat Lengkap -->
                        <div class="mb-6">
                            <label for="alamat_lengkap" class="block text-sm font-semibold text-gray-700 mb-1">Alamat Lengkap</label>
                            <textarea name="alamat_lengkap" id="alamat_lengkap" rows="3" class="w-full text-sm border-gray-300 rounded-md shadow-sm">{{ old('alamat_lengkap') }}</textarea>
                        </div>

                        <!-- Upload Photo -->
                        <div class="mb-6">
                            <label class="block text-sm font-semibold text-gray-700 mb-1">Foto Siswa</label>
